  ...
  [[session dataTaskWithRequest:URLRequest
    ...
    if (tokenResponse.idToken) {
      ...
      if (issuer && [issuer.path containsString:@"{tenantid}"]) {
        // The Azure AD discovery document's "issuer" value contains the special placeholder "{tenantid}". This needs to
        // be replaced with the actual tenant ID of the authenticated user, from the "tid" claim of the ID token,
        // before validation.
